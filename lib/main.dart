...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('SolidarMed Hackathon- Meetup'),
      ),
      body: ListView(
        children: <Widget>[
          Image.asset('assets/codelab.png'),
          SizedBox(height: 8),
          IconAndDetail(Icons.calendar_today, '1 November, 2020'),
          IconAndDetail(Icons.location_city, ' 33 Carry Street Rhodene, Masvingo'),
          ...
          Paragraph(
            'Join us for a day full of SolidarMed Workshops and Pizza!',
          ),
          Consumer<ApplicationState>(
